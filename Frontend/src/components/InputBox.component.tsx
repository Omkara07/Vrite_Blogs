...
const InputBox: React.FC<Props> = ({ type, placeholder, value, icon, name, onChange }) => {
    ...
    return (
        <div className='flex items-center w-[70%]'>
            ...
            <input className='transition duration-300 ease-in-out focus:border focus:border-gray-400 focus:ring-2 focus:ring-gray-400 pl-9 px-3 py-4 bg-gray-100 rounded-xl w-full' type={passvis ? "text" : type} placeholder={placeholder} name={name} onChange={onChange} />
            {
                type == "password" ?
